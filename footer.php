<footer class="footer content">
    <div class="rodape">
        ...
        <a <?php if ($pg == 2){echo "class='atual'";}?> href="index.php?sessao=2">Clientes</a>
        <a <?php if ($pg == 3){echo "class='atual'";}?> href="index.php?sessao=3">Administração</a>
        <a <?php if ($pg == 4){echo "class='atual'";}?> href="index.php?sessao=4">CADASTRAR</a>
